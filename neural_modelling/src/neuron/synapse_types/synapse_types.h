...
static input_t synapse_types_get_excitatory_input(index_t neuron_index);
...
static input_t synapse_types_get_inhibitory_input(index_t neuron_index);
...
//! \param[in] neuron_index  the neuron id currently being considered
//! \return Nothing
static void synapse_types_print_input(index_t neuron_index);
