...
class SynapseDynamicsSTDPTarget(
    ...
    def __init__(
        ...
        try:
            can_be_modulated = timing_dependence.target
        except:
            raise Exception("Incompatible time dependence")
    ...
    def is_same_as(self, synapse_dynamics):
        if not isinstance(synapse_dynamics, SynapseDynamicsSTDPTarget):
            return False
        return (
