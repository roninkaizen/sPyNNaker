...
class TimingDependenceSpikePairTarget(AbstractTimingDependence):
    def __init__(self, tau_plus=20.0, tau_minus=20.0):
        AbstractTimingDependence.__init__(self)
        self._tau_plus = tau_plus
        self._tau_minus = tau_minus

        self._synapse_structure = SynapseStructureWeightTargetTrace()
    ...
    def is_same_as(self, timing_dependence):
        if not isinstance(timing_dependence, TimingDependenceSpikePairTarget):
            return False
